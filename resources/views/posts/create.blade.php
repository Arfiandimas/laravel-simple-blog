                        ...
                        <form method="POST" action="{{ route('posts.store') }}" class="space-y-6">
                            ...
                            <div>
                                <label for="is_draft" class="inline-flex items-center">
                                    ...
                                    <input id="is_draft" type="checkbox" value="1" name="is_draft" {{ old('is_draft') ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
