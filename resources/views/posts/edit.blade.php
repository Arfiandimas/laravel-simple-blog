    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        <form method="post" action="{{ route('posts.update', ['post' => $post->id]) }}" class="space-y-6">
                            @csrf
                            @method('PUT')
                            ...
                            <div>
                                <label for="is_draft" class="inline-flex items-center">
                                    ...
                                    <input id="is_draft" type="checkbox" name="is_draft" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('is_draft', $post->is_draft) ? 'checked' : '' }}>
